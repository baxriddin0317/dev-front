  ...
  return (
    <>
      ...
      >
        {!loading && (
          <div className="">
            <div className="flex lg:flex-row md:flex-row flex-col lg:items-center justify-between pb-4 border-b border-gray-400 dark:border-gray-400 dark:text-gray-300">
              ...
              <div className="lg:text-right text-left">
                ...
                <p className="text-sm text-gray-500 dark:text-[#9E9E9EFF] mt-2">
            ...
            <div className="flex lg:flex-row md:flex-row flex-col justify-between pt-4">
              <div className="mb-3 md:mb-0 lg:mb-0 flex flex-col">
                ...
                <span className="text-sm text-gray-500 dark:text-[#9E9E9EFF] block">
        ...
        {!loading && (
          <div className="border rounded-xl border-gray-400 p-8 py-6 bg-gray-50 dark:bg-gray-900 dark:border-gray-400">
            <div className="flex lg:flex-row md:flex-row flex-col justify-between">
              <div className="mb-3 md:mb-0 lg:mb-0  flex flex-col sm:flex-wrap">
                ...
                <span className="text-sm text-gray-900 dark:text-[#9E9E9EFF] font-semibold font-serif block">
                  {data.paymentMethod}
                </span>
              </div>
              <div className="mb-3 md:mb-0 lg:mb-0  flex flex-col sm:flex-wrap">
                <span className="mb-1 font-bold font-serif text-sm uppercase text-gray-900 dark:text-gray-500 block">
                  Shipping Cost
                </span>
                <span className="text-sm text-gray-500 dark:text-[#9E9E9EFF] font-semibold font-serif block">
