const myTheme = {
  ...
  // TableFooter
  tableFooter: {
    base: 'px-4 py-3 border-t border-gray-400 dark:border-gray-400 bg-white text-gray-500 dark:text-gray-400 dark:bg-gray-800',
  },
  // TableRow
  tableRow: {
    base: '',
  ...
  // TableHeader
  tableHeader: {
    base: 'text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b border-gray-400 dark:border-gray-400 bg-gray-100 dark:text-gray-400 dark:bg-gray-800',
  },
  // TableContainer
  tableContainer: {
    base: 'w-full overflow-hidden border border-gray-400 dark:border-gray-400 rounded-lg ring-1 ring-black ring-opacity-5',
  },
  // TableCell
  tableCell: {
    base: 'px-4 py-3',
  ...
  // TableBody
  tableBody: {
    base: 'bg-gray-50 divide-y divide-gray-100 dark:divide-gray-700 dark:bg-gray-800 text-gray-700 dark:text-gray-400',
  },
  // DropdownItem
  ...
  // Dropdown
  dropdown: {
    base: 'absolute w-56 p-2 mt-2 text-gray-600 bg-gray-50 dark:bg-gray-800 dark:border-gray-400 border border-gray-400 rounded-lg shadow-md min-w-max-content',
    align: {
      left: 'left-0',
      right: 'right-0',
    },
  ...
  textarea: {
    ...
    active:
      'focus:border-purple-400 border-gray-400 dark:border-gray-400 dark:focus:border-gray-600 dark:bg-gray-700 dark:focus:ring-gray-300 focus:ring focus:ring-purple-300',
  ...
  select: {
    ...
    active:
      'focus:border-gray-200 border-gray-400 dark:border-gray-400 focus:shadow-none focus:ring focus:ring-green-300 dark:focus:border-gray-500 dark:focus:ring-gray-300 dark:bg-gray-700',
    select: 'leading-5',
    disabled: 'cursor-not-allowed opacity-50 bg-gray-300 dark:bg-gray-800',
    valid:
      'border-green-600 dark:bg-gray-700 focus:border-green-400 dark:focus:border-green-400 focus:ring focus:ring-green-200 dark:focus:ring-green-200',
  ...
  input: {
    ...
    active:
      'focus:border-gray-400 border-gray-200 dark:border-gray-400 focus:ring focus:ring-green-300 dark:focus:border-gray-500 dark:focus:ring-gray-300 dark:bg-gray-700',
    disabled: 'cursor-not-allowed opacity-50 bg-gray-300 dark:bg-gray-800',
    valid:
      'border-green-600 dark:bg-gray-700 focus:border-green-400 dark:focus:border-green-400 focus:ring focus:ring-green-200 dark:focus:ring-green-200',
    invalid:
  ...
  button: {
    ...
    primary: {
      base: 'text-white bg-3bc48d border border-transparent',
      active: 'active:bg-[#3bc48d]  hover:bg-[#3bc48d]  focus:ring ',
      disabled: 'opacity-50 cursor-not-allowed',
    },
    outline: {
    ...
    link: {
      base: 'text-gray-600 dark:text-gray-400 focus:outline-none border',
      active:
        'active:bg-transparent hover:bg-gray-100 focus:ring dark:hover:bg-gray-500 dark:hover:text-gray-300 dark:hover:bg-opacity-10',
      disabled: 'opacity-50 cursor-not-allowed',
    },
